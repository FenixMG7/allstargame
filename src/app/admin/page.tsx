...
function EquipesTab() {
  ...
  const AllCoachesBlock = () => (
    <div style={{ position: 'relative', zIndex: 2, margin: '6px 10px 0', borderRadius: 0, overflow: 'hidden', background: 'rgba(212,175,55,0.06)', border: '1px solid rgba(212,175,55,0.4)' }}>
      {/* Header */}
      <div style={{ background: 'linear-gradient(90deg, rgba(212,175,55,0.75) 0%, rgba(212,175,55,0.3) 100%)', padding: '4px 12px' }}>
        <p style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: 12, color: 'white', letterSpacing: '0.2em', margin: 0 }}>🧑‍💼 COACHS</p>
      </div>
      {/* Grille 2 colonnes */}
